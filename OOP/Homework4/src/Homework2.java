...
public class Homework2 {
    public static double baseballAverage = 0;
    ...
    public Homework2() {
        ...
        while (quit == false) {
            GameScore bbScore = new BaseballScore();
            int guessCount = 0;
            ...
            while (newStrikes.getStrikes() != maxSize) {
                ...
                ArrayList<Boolean> checkSpot = new ArrayList<Boolean>();
                checkSpot.clear();
                checkSpot.add(false);
                checkSpot.add(false);
                checkSpot.add(false);
            ...
            bbScore.score(guessCount - 1);
            System.out.println("Your score is " + bbScore.getTotalScore());
            Homework4.baseballList.add(bbScore.getTotalScore()); // Puts total score into an array
            Homework4.baseballCount++; // Increase count of how many times the player has played
            
            // Add current score into the game history arraylist
            GameHistory baseballHistory = new GameHistory("Baseball",bbScore.getTotalScore());
            History bbHistory = baseballHistory.displayHistory();
            Homework4.gameHistory.add(bbHistory.description());
